...
`dotspacemacs/user-config' first."
  ;; FIXME attempt to use the theming layer to redefine comment color.
  ;; Partially this is because applying the colors below appears to require
  ;; a complete restart of emacs.
